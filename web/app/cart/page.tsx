  ...
  return (
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <div className="rounded-[28px] border border-orange-500/10 bg-slate-950/40 p-6 text-slate-300">
          Your cart is empty.
        </div>
      ) : (
        <div className="rounded-[28px] border border-orange-500/10 bg-slate-950/40 p-6">
